      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8">
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <svg className="w-8 h-8 text-text-muted group-hover:text-secondary transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1}>
          ...
          <p className="mt-3 text-xs text-secondary opacity-0 group-hover:opacity-100 transition-opacity">
            Gestionar noticias →
          </p>
        </Link>
