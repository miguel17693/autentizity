  ...
  return (
    <>
      ...
      <section className="relative aspect-[16/10] sm:aspect-auto sm:h-[50vh] sm:min-h-[360px] flex items-end">
        ...
        />
        <Image
          src={movimiento.coverImageHeroDesktop || movimiento.coverImageHero || movimiento.coverImage || "/images/logo-transparent.png"}
          alt={movimiento.title}
          fill
          priority
            ...
            <div className="mt-16 lg:mt-24 space-y-16">
              {publishedEventos.length > 0 && (
                <div>
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <span className="text-tertiary text-[12px] font-medium tracking-[0.15em] uppercase">Eventos</span>
                  </div>
              ...
              {publishedNoticias.length > 0 && (
                <div>
                  <div className="flex items-center gap-4 mb-6">
                    <div className="brand-line" />
                    <span className="text-tertiary text-[12px] font-medium tracking-[0.15em] uppercase">Noticias</span>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
