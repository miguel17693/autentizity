            ...
            <div className="mt-16 lg:mt-24 space-y-16">
              {publishedEventos.length > 0 && (
                <div>
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <span className="text-rose text-[12px] font-medium tracking-[0.15em] uppercase">Eventos</span>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {publishedEventos.slice(0, 4).map((ev) => (
                      ...
                      >
                        ...
                        <div className="p-4">
                          <h4 className="font-serif text-base text-primary font-normal group-hover:text-gold transition-colors">
                            {ev.title}
                          </h4>
                        </div>
                      </Link>
              ...
              {publishedNoticias.length > 0 && (
                <div>
                  <div className="flex items-center gap-4 mb-6">
                    <div className="brand-line" />
                    <span className="text-rose text-[12px] font-medium tracking-[0.15em] uppercase">Noticias</span>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {publishedActividades.length > 0 && (
                <div>
                  <div className="flex items-center gap-4 mb-6">
                    <div className="brand-line" />
                    <span className="text-rose text-[12px] font-medium tracking-[0.15em] uppercase">Actividades</span>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
