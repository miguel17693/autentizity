...
import { getActividades } from "@/lib/data/store";

export const dynamic = "force-dynamic";

export default async function ActividadesTodosPage({
  searchParams,
}: {
  ...
  const published = isPreview
    ? allActividades
    : allActividades.filter((a) => a.status === "published");
  ...
  if (tagsParam) {
    ...
    filtered = filtered.filter((a) => tagList.some((t) => a.tags.includes(t)));
  }
    ...
    <>
      ...
      <section className="py-12 sm:py-16 lg:py-24">
        <div className="max-w-[1400px] mx-auto px-5 sm:px-6 lg:px-12">
          <Suspense>
            <FilterBar variant="actividades" availableTags={allTags} />
          </Suspense>
