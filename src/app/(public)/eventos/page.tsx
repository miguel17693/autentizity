            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 sm:gap-8 -mx-5 sm:mx-0">
              {items.map((event) => (
                <Link
                  ...
                  className={`group block bg-white border overflow-hidden hover:shadow-xl hover:shadow-black/5 hover:-translate-y-1 transition-all duration-500 rounded-2xl ${event.status === "draft" ? "border-gold border-dashed" : "border-border-light"}`}
                >
                  <div className="relative h-48 sm:h-56 lg:h-64 overflow-hidden">
                    {event.status === "draft" && (
                      <div className="absolute top-4 right-4 z-10 bg-gold text-white text-[10px] font-semibold tracking-[0.1em] uppercase px-2.5 py-1">
                        Borrador
                      </div>
                    )}
                    <Image
                    ...
                    <div className="absolute top-4 left-4 flex gap-2">
                      ...
                      {event.featured && (
                        <span className="text-[11px] font-medium tracking-[0.1em] uppercase text-white bg-gold/80 backdrop-blur-sm px-3 py-1.5">
                          Destacado
                        </span>
                      )}
                    </div>
                  ...
                  <div className="p-6 lg:p-8">
                    ...
                    <h2 className="font-serif text-xl lg:text-2xl text-primary font-normal leading-tight group-hover:text-gold transition-colors">
                      {event.title}
                    </h2>
            ...
            {movItems.length > 0 ? (
              movItems.map((mov) => (
                ...
                >
                  ...
                  <h3 className="font-serif text-lg text-primary font-normal group-hover:text-gold transition-colors">
                    {mov.title}
                  </h3>
                  ...
                  <div className="mt-4 pt-4 border-t border-border-light flex items-center gap-2 text-gold text-[12px] font-medium tracking-[0.06em] uppercase opacity-0 group-hover:opacity-100 transition-opacity">
                    Ver movimiento
