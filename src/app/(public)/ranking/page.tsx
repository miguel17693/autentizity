...
export default function RankingPage() {
  return (
    <>
      {/* Hero */}
      <section className="bg-primary flex flex-col min-h-[65vh]">
        <div className="flex-1 flex flex-col items-center justify-end max-w-[1400px] mx-auto px-5 sm:px-6 lg:px-12 text-center w-full pt-12">
        ...
        <div className="flex-1 flex items-center justify-center pb-12">
          <div className="flex items-center justify-center gap-12 lg:gap-16 px-5">
            ...
            {categories.map((cat, i) => (
              <ScrollReveal key={cat.title} delay={i * 0.1}>
                <div className="bg-white p-8 h-full group hover:shadow-lg hover:shadow-black/5 hover:-translate-y-1 transition-all duration-500">
                  <div className="text-secondary group-hover:text-secondary-dark transition-colors mb-6">
                    {cat.icon}
                  </div>
            ...
            {timeline.map((item, i) => (
              <ScrollReveal key={item.step} delay={i * 0.12}>
                <div className="relative">
                  <span className="font-serif text-6xl text-tertiary/20 font-light leading-none">
                    {item.step}
                  </span>
