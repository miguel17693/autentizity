...
export default function Footer() {
  return (
    <footer className="bg-[#012D2D] text-white">
      <div className="max-w-[1400px] mx-auto px-5 sm:px-6 lg:px-12 py-5 sm:py-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <nav className="flex flex-wrap items-center gap-x-5 gap-y-1">
            {links.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="text-white/40 hover:text-white text-[11px] font-light tracking-[0.04em] transition-colors"
              >
                {link.label}
              </Link>
            ))}
          ...
          {/* Email + Social icons on same row */}
          <div className="flex items-center gap-4">
            <a
              href="mailto:comunidad@autentizity.org"
              className="text-white/40 hover:text-white text-[11px] font-light transition-colors"
            >
        ...
        {/* Bottom line — copyright + legal in one tight row */}
        <div className="mt-4 pt-3 border-t border-white/[0.06] flex flex-wrap justify-between items-center gap-x-6 gap-y-1">
