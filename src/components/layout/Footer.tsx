        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/70 text-sm leading-relaxed mt-4">
              ...
              basada en la autenticidad, el bienestar y el compromiso social.
            </p>
            {/* Social */}
          ...
          {/* Navigation */}
          <div>
            <h3 className="font-heading font-bold text-lg mb-4">Navegación</h3>
          ...
          {/* Ecosistema */}
          <div>
            <h3 className="font-heading font-bold text-lg mb-4">Ecosistema</h3>
            <ul className="space-y-3">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/70">
              ...
              <li>
                <a
                  href="mailto:miguelgarzon@autentizity.org"
                  className="hover:text-white transition-colors"
                >
                  miguelgarzon@autentizity.org
                </a>
              </li>
              <li className="pt-2">
                <a
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-white/50 text-sm">
            © {new Date().getFullYear()} AuthentiZity. Todos los derechos
            reservados.
          </p>
